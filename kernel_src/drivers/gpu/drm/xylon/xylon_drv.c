 ...
 * Revision: Josip Vladic <josip.vladic@logicbricks.com>
 * Date of revision: 29.05.2018.
 *
...
static void xylon_drm_unload(struct drm_device *dev)
{
...
static struct drm_driver xylon_drm_driver = {
	...
	.get_vblank_counter = xylon_drm_vblank_count,
